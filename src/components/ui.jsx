...
// Input password dengan tombol tampilkan/sembunyikan — dipakai di semua form
// login/daftar/ganti password supaya pengguna bisa memeriksa ketikannya
// sendiri sebelum submit (aksesibilitas & mengurangi salah ketik).
export function PasswordField({ value, onChange, onKeyDown, placeholder, autoComplete }) {
